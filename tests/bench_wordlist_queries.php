...
$cases = [
    ...
    ['label' => 'Contenant seul (route documentee : /woerter/enthalten/che) -- predicat non indexe', 'path' => 'enthalten/che'],
    ['label' => 'Avec, repetitions comptees (route documentee : /woerter/mit-buchstaben/a/a/r) -- predicat non indexe, aucun ancrage', 'path' => 'mit-buchstaben/a/a/r'],
    ['label' => 'Sans, lettre exclue -- predicat non indexe, aucun ancrage', 'path' => 'ohne/z'],
    ['label' => 'Motif (route documentee : /woerter/5-buchstaben/muster/c--e-)', 'path' => '5-buchstaben/muster/c--e-'],
    ...
    ['label' => "Longueur seule sur le panier le plus grand de la base (11 lettres, 127 772 lignes) + avec impossible -- pire cas pathologique (0 resultat, plafond quand meme applique)", 'path' => '11-buchstaben/mit-buchstaben/z/z/z/z/z/q/q/q'],
];
...
$lines = [
    ...
    '                      127 772 lignes dans ce seul panier, 0 resultat pour un "mit-buchstaben"',
    ...
    '',
    'Pour "mit-buchstaben"/"enthalten"/"ohne" employes seuls (aucune longueur, aucun prefixe, aucun',
